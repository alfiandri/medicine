...
$kode = $_GET['kode'];
if ($kode == ""){
    echo "<script>alert('Harap Isi Kabupaten Terlebih Dahulu');window.close();</script>";
}
...
'Content-Type:application/json'
 ...
 curl_setopt($ch, CURLOPT_URL, "https://apijkn.bpjs-kesehatan.go.id/vclaim-rest/referensi/kecamatan/kabupaten/". $kode ."");
...
<head>
    ...
    function post_value(s) {
        opener.document.getElementById('kec').value = s;
        self.close();
    }
    </script>
    <script>
