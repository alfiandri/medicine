...
if (isset($_POST['kab'])) {
    $cari = $_POST['cari2'];
    $url = "" . $base_url . "/" . $service . "/referensi/kecamatan/kabupaten/" . $cari . "";
                                        ...
                                        <form action="" method="post">
                                            <div class="col-sm-12">
                                                <div class="input-group">
                                                    <input type="text" class="form-control form-control-sm" placeholder="Masukkan Kata Kunci" name="cari2" require>
                                                    <button class="btn btn-danger btn-sm" type="submit" name="kab">Cari</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
