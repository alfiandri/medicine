<div class="page-header">
   <div class="header-wrapper row m-0">
         ...
         <div class="form-group w-100">
            <div class="Typeahead Typeahead--twitterUsers">
               <div class="u-posRelative">
                  <input class="demo-input Typeahead-input form-control-plaintext w-100" type="text" placeholder="Search Module .." name="q" title="" autofocus>
      ...
      <div class="header-logo-wrapper col-auto p-0">
         <div class="logo-wrapper"><a href="index"><img class="img-fluid" src="../assets/Icon.png" alt=""></a></div>
