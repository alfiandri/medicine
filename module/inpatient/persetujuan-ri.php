<?php
$master = "Rawat Jalan";
$page = "Anjuran & Persetujuan Rawat Inap";
require 'head.php';
?>
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <ul class="nav nav-pills" id="pills-icontab" role="tablist">
                              <li class="nav-item"><a class="nav-link active btn-sm" id="pills-iconhome-tab" data-bs-toggle="pill" href="#pills-iconhome" role="tab" aria-controls="pills-iconhome" aria-selected="true"><i class="icofont icofont-ui-home"></i>Persetujuan Rawat Inap</a></li>
                              <li class="nav-item"><a class="nav-link btn-sm" id="pills-iconcontact-tab" data-bs-toggle="pill" href="#pills-iconcontact" role="tab" aria-controls="pills-iconcontact" aria-selected="false"><i class="icofont icofont-contacts"></i>Penolakan Rawat Inap</a></li>
                           </ul>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="card-body">
                        <div class="tab-content" id="pills-icontabContent">
                           <div class="tab-pane fade show active" id="pills-iconhome" role="tabpanel" aria-labelledby="pills-iconhome-tab">
                              ...
                              <div class="mb-1 row">
                                 <label for="inputPassword" class="col-sm-2 col-form-label-sm ">Poli Rawat</label>
                                 <div class="col-sm-10">
                                    <select name="" class="form-select form-select-sm" id="">
                                    </select>
                                 </div>
                              ...
                              <div class="mb-1 row">
                                 <label for="inputPassword" class="col-sm-2 col-form-label-sm ">Rencana Tindakan Operasi</label>
                                 <div class="col-sm-10">
                                    <textarea name="" id="" class="form-control form-control-sm" cols="30" rows="5"></textarea>
                                 </div>
                              </div>
                              <div class="mb-1 row">
                                 <label for="inputPassword" class="col-sm-2 col-form-label-sm ">Indikasi Rawat Inap</label>
                                 <div class="col-sm-10">
                                    <textarea name="" id="" class="form-control form-control-sm" cols="30" rows="5"></textarea>
                                 </div>
                              </div>
                           ...
                           <div class="tab-pane fade" id="pills-iconcontact" role="tabpanel" aria-labelledby="pills-iconcontact-tab">
                              ...
                              <div class="mb-1 row">
                                 <label for="inputPassword" class="col-sm-2 col-form-label-sm ">Umur</label>
                                 <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-sm">
                                 </div>
                              </div>
                              ...
                              <div class="mb-1 row">
                                 <label for="inputPassword" class="col-sm-2 col-form-label-sm ">Alamat</label>
                                 <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-sm">
                                 </div>
                              </div>
                              <div class="mb-1 row">
                                 <label for="inputPassword" class="col-sm-2 col-form-label-sm ">Bukti Diri KTP </label>
                                 <div class="col-sm-10">
                              ...
                              <div class="mb-1 row">
                                 <label for="inputPassword" class="col-sm-2 col-form-label-sm ">Catatan Penolakan Rawat Inap</label>
                                 <div class="col-sm-10">
                                    <textarea name="" id="" class="form-control form-control-sm" cols="30" rows="5"></textarea>
                                 </div>
                              </div>
                              <div class="mb-1 row">
                                 <label for="inputPassword" class="col-sm-2 col-form-label-sm ">Terhadap Pasien</label>
                                 <div class="col-sm-10">
                                    <select name="" class="form-select form-select-sm" id=""></select>
                                 </div>
                              </div>
                              ...
                              <div class="mb-1 row">
                                 <label for="inputPassword" class="col-sm-2 col-form-label-sm ">No.RM</label>
                                 <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-sm">
                                 </div>
                              </div>
