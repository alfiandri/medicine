                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <ul class="nav nav-pills" id="pills-icontab" role="tablist">
                              ...
                              <li class="nav-item"><a class="nav-link btn-sm" id="pills-iconcontact-tab" data-bs-toggle="pill" href="#pills-iconcontact" role="tab" aria-controls="pills-iconcontact" aria-selected="false"><i class="icofont icofont-contacts"></i>Data Permintaan Privasi</a></li>
                           </ul>
                        </div>
                     </div>
                  </div>
                     ...
                     <div class="card-body">
                        <div class="tab-content" id="pills-icontabContent">
                           <div class="tab-pane fade show active" id="pills-iconhome" role="tabpanel" aria-labelledby="pills-iconhome-tab">
                              ...
                              <div class="mb-1 row">
                                 <label for="inputPassword" class="col-sm-2 col-form-label-sm ">Nama Keluarga</label>
                                 <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-sm" name="" id="">
                                 </div>
                              </div>
                              ...
                              <div class="mb-1 row">
                                 <label for="inputPassword" class="col-sm-2 col-form-label-sm ">Nama Kerabat</label>
                                 <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-sm" name="" id="">
                                 </div>
                              </div>
                              <div class="mb-1 row">
                                 <label for="inputPassword" class="col-sm-2 col-form-label-sm ">Nama Lainnya</label>
                                 <div class="col-sm-10">
                                    <input type="text" class="form-control form-control-sm" name="" id="">
                                 </div>
                              </div>
                              <div class="mb-1 row">
                                 <label for="inputPassword" class="col-sm-2 col-form-label-sm ">Privasi Khusus</label>
                                 <div class="col-sm-10">
                                    <select name="" class="form-select form-select-sm" id="">
                                       <option value="">Saat Wawancara Klinis</option>
                                       <option value="">Saat Pemeriksaan Fisik</option>
                                       <option value="">Pada Saat Perawatan</option>
                                 ...
                                 <table class="display table-sm" id="basic-1">
                                    <thead>
                                       <tr>
                                          ...
                                          <th>Tidak Mengizinkan</th>
                                          <th>Privasi Khusus</th>
                                       </tr>
                                    </thead>
                                    <tbody>
                                       <tr>
