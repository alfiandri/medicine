   ...
   <div class="header-wrapper row m-0">
      ...
      <div class="left-header col horizontal-wrapper ps-0">
         <ul class="horizontal-menu">
                     ...
                     <div class="row">
                        <div class="col mega-box">
                           ...
                           <div class="link-section icon">
                              ...
                              <ul>
                                 <li><a href="menu_a">[A]. Registrasi Pasien</a></li>
                                 <li><a href="javascript:;">[B]. Billing Pasien</a></li>
                                 <li><a href="javascript:;">[C]. Kartu Pasien</a></li>
                                 <li><a href="javascript:;">[D]. Buku Tamu</a></li>
                                 <li><a href="javascript:;">[E]. Jadwal Dokter</a></li>
                                 <li><a href="javascript:;">[F]. Ketersediaan Ruangan Inap dan OK</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
            ...
            <li class="level-menu outside"><a class="nav-link" href="javascript:;"><i data-feather="inbox"></i><span>Module</span></a>
               <ul class="header-level-menu menu-to-be-close">
                  <li><a href="javascript:;" data-original-title="" title=""> <i data-feather="file"></i><span>Billing</span></a></li>
                  <li><a href="javascript:;" data-original-title="" title=""> <i data-feather="users"></i><span>Registrasi</span></a>
                     <ul class="header-level-sub-menu">
                        <li><a href="javascript:;" data-original-title="" title=""> <i data-feather="user"></i><span>IGD/UGD</span></a></li>
                        <li><a href="javascript:;" data-original-title="" title=""> <i data-feather="user-minus"></i><span>Rawat Inap</span></a></li>
                        <li><a href="javascript:;" data-original-title="" title=""> <i data-feather="user-check"></i><span>Rawat Jalan</span></a></li>
                     </ul>
                  </li>
                  <li><a href="javascript:;" data-original-title="" title=""> <i data-feather="heart"></i><span>Buku Tamu</span></a></li>
                  <li><a href="javascript:;" data-original-title="" title=""> <i data-feather="monitor"></i><span>Tempat Tidur</span></a></li>
                  <li><a href="javascript:;" data-original-title="" title=""> <i data-feather="box"></i><span>Antrian</span></a></li>
               </ul>
            </li>
         </ul>
      </div>
