...
if($_GET['kd']=='sukses'){
   echo "<script type='text/javascript'>toastr.success('Rencana Kontrol Berhasil Di insert')</script>";
} elseif ($_GET['kd']=='gagal') {
   echo "<script type='text/javascript'>toastr.error('Rencana Kontrol Gagal Di insert')</script>";
} elseif ($_GET['kd']=='hpssukses') {
   echo "<script type='text/javascript'>toastr.success('Rencana Kontrol Berhasil Di Hapus')</script>";
} elseif ($_GET['kd']=='hpsgagal') {
   echo "<script type='text/javascript'>toastr.error('Rencana Kontrol Gagal Di Hapus')</script>";
}
                                            ...
                                            <div class="mb-1 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" readonly class="form-control form-control-sm"
                                                        id="idpoli" value="<?php echo $poli;?>" name="poliKontrol"
                                                        require>
                                                </div>
                                            </div>
                                            <div class="mb-1 row">
                                        ...
                                        <div class="table-responsive">
                                            <table class="display table-sm" id="basic-1">
                                                ...
                                                <tbody>
                                                    <?php
                                                         $no = 0;
                                                         $admin = $mysqli->query("SELECT * FROM t_skontrol ORDER BY id DESC");
