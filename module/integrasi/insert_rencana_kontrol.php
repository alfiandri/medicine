              ...
              <!-- form start -->             
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="noSep" id="idnosep" value="<?php echo $noSep;?>" placeholder="Masukkan No SEP" required>
                  </div>
                  <div class="form-group">
                  <div class="form-group">
                    <label for="exampleInputtglRencanaKontrol">Tanggal Rencana Kontrol</label>
                    <input type="date" class="form-control" name="tglRencanaKontrol" id="idtanggal" placeholder="Masukkan Tanggal Rencana Kontrol" required>
                  </div>
                  <label for="exampleInputpoliKontrol">Poli Kontrol</label>
                    <input type="text" class="form-control" name="poliKontrol" id="idpoli" value="<?php echo $poli;?>" required readonly>
                    </select>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputkodeDokter">Dokter</label>
                    <select class="custom-select form-control-border border-width-2" name="kodeDokter" id="iddokter" required="true">
                    </select>
                  </div>
                  <div class="form-group">
