...
if (isset($_POST['datakunjungan'])) {
    ...
    curl_setopt($ch1, CURLOPT_URL, "https://apijkn.bpjs-kesehatan.go.id/vclaim-rest/Monitoring/Kunjungan/Tanggal/" . $tglpelayanan1 . "/jnsPelayanan/" . $jnslayanan1 . "");
...
if (isset($_POST['historypelayanan'])) {
    ...
    curl_setopt($ch2, CURLOPT_URL, "https://apijkn.bpjs-kesehatan.go.id/vclaim-rest/monitoring/HistoriPelayanan/NoKartu/" . $nokartu2 . "/tglMulai/" . $tglawal2 . "/tglAkhir/" . $tglakhir2 . "");
...
if (isset($_POST['dataklaim'])) {
    ...
    curl_setopt($ch3, CURLOPT_URL, "https://apijkn.bpjs-kesehatan.go.id/vclaim-rest/Monitoring/Klaim/Tanggal/" . $tanggal3 . "/JnsPelayanan/" . $jnslayanan3 . "/Status/" . $status3 . "");
...
if (isset($_POST['jasa'])) {
    ...
    curl_setopt($ch4, CURLOPT_URL, "https://apijkn.bpjs-kesehatan.go.id/vclaim-rest/monitoring/JasaRaharja/JnsPelayanan/" . $jnslayanan4 . "/tglMulai/" . $tglawal4 . "/tglAkhir/" . $tglakhir4 . "");
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <ul class="nav nav-pills" id="pills-icontab" role="tablist">
                                        ...
                                        <li class="nav-item"><a class="nav-link btn-sm" id="pills-riwayat-tab" data-bs-toggle="pill" href="#pills-riwayat" role="tab" aria-controls="pills-riwayat" aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>Riwayat Pelayanan
                                                Peserta</a></li>
                                        ...
                                        <li class="nav-item"><a class="nav-link btn-sm" id="pills-jasa-tab" data-bs-toggle="pill" href="#pills-jasa" role="tab" aria-controls="pills-jasa" aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>Data Klaim Jasa
                                                Raharja</a></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="tab-pane fade show active" id="pills-iconhome" role="tabpanel" aria-labelledby="pills-iconhome-tab">
                                        <div class="table-responsive">
                                            <form action="" method="post">
                                                <div class="mb-1 row">
                                                    <div class="col-sm-8">
                                                        <select name="jnsPelayanan1" class="form-select form-select-sm" require>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="input-group">
                                                            <input type="date" class="form-control form-control-sm" placeholder="Masukan Tahun" name="tglpelayanan1">
                                                            <button class="btn btn-danger btn-sm" type="submit" name="datakunjungan">Cari</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                    ...
                                    <div class="tab-pane fade" id="pills-riwayat" role="tabpanel" aria-labelledby="pills-riwayat-tab">
                                        <div class="table-responsive">
                                            <form action="" method="post">
                                                <div class="mb-1 row">
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control form-control-sm" placeholder="Masukkan Tanggal Awal" onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" name="tglawal2" required>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control form-control-sm" placeholder="Masukkan Tanggal Akhir" onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" name="tglakhir2" required>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control form-control-sm" placeholder="No.Kartu Peserta" name="nokartu2">
                                                            <button class="btn btn-danger btn-sm" type="submit" name="historypelayanan">Cari</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                        ...
                                        <div class="table-responsive">
                                            <form action="" method="post">
                                                <div class="mb-1 row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <select name="jnsPelayanan3" class="form-select form-select-sm" id="">
                                                            <option selected="true" disabled="disabled">-- Pilih Jenis
                                                                Pelayanan --</option>
                                                            <option value="1">Rawat Inap</option>
                                                            <option value="2">Rawat Jalan</option>
                                                    ...
                                                    <div class="col-sm-4">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control form-control-sm" placeholder="Tanggal Pulang" onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" name="tanggal3" required>
                                                            <button class="btn btn-danger btn-sm" type="submit" name="dataklaim">Cari</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                    ...
                                    <div class="tab-pane fade" id="pills-jasa" role="tabpanel" aria-labelledby="pills-jasa-tab">
                                        <div class="table-responsive">
                                            <form action="" method="post">
                                                <div class="mb-1 row">
                                                    <div class="col-sm-4">
                                                        <input type="date" placeholder="Masukkan Tanggal Awal" onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" name="tglawal4" required>
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <input type="date" class="form-control form-control-sm" placeholder="Masukkan Tanggal Akhir" onfocus="(this.type='date')" onblur="if(this.value==''){this.type='text'}" name="tglakhir4" required>
                                                    </div>

                                                    <div class="col-sm-4">
                                                        <div class="input-group">
                                                            <select name="jnsPelayanan4" class="form-select form-select-sm">
                                                            ...
                                                            <button class="btn btn-danger btn-sm" type="submit" name="jasa">Cari</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
