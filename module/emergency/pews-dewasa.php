                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Catatan PEWS Dewasa</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">1. Laju Respirasi/Menit</label>
                                ...
                                <div class="col-5">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">5. Laju Jantung/Menit</label>
                                        <select name="" class="form-select" id="">
                                ...
                                <div class="col-5">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">6. Kesadaran</label>
                                        <select name="" class="form-select" id="">
                                ...
                                <div class="col-5">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">3. Suplemen Oksigen</label>
                                        <select name="" class="form-select" id="">
                                ...
                                <div class="col-5">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">7. Temperature</label>
                                        <select name="" class="form-select" id="">
                                            <option value="">36.1 - 38</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-1">
