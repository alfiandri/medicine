                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Catatan Observasi IGD</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">HR (x/menit)</label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1">
                                    </div>
                                </div>
                                <div class="col-2">
