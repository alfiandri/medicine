                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">MEOWS Obstetri</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-5">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">6. Denyut Janutng</label>
                                        <select name="" class="form-select" id="">
                                ...
                                <div class="col-5">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">7. Kesadaran</label>
                                        <select name="" class="form-select" id="">
                                ...
                                <div class="col-5">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">3. Temperature</label>
                                        <select name="" class="form-select" id="">
                                            <option value="">36-37.9</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-1">
                                ...
                                <div class="col-5">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">8. Bau Cairan Ketuban</label>
                                        <select name="" class="form-select" id="">
                                            <option value="">Khas</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-1">
                                ...
                                <div class="col-5">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">4. Tekanan Darah Sistolik</label>
                                        <select name="" class="form-select" id="">
                                ...
                                <div class="col-5">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">9. Discharge / Loda</label>
                                        <select name="" class="form-select" id="">
                                ...
                                <div class="col-5">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">5. Tekanan Darah Diastole</label>
                                        <select name="" class="form-select" id="">
                                            <option value="">
                                                < 90 </option>
                                        </select>
                                ...
                                <div class="col-5">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">10. Proteinuria</label>
                                        <select name="" class="form-select" id="">
