            ...
            <div class="page-body">
                <div class="container-fluid">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-6">
                                <h3>Penilaian Tambahan Perilaku Kekerasan</h3>
                            </div>
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Tambahan Perilaku Kekerasan</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <form class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Insiden Kekerasaan Baru-baru Ini</label>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Riwayat Penggunaan Senjata</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                                <option value="2">Ya</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Usia Dibawah Umur 35 Tahun</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                                <option value="2">Ya</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Riwayat Tindakan Berbahaya</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                                <option value="2">Ya</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Kekerasan Masa Kanak-kanak</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                                <option value="2">Ya</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Kekurangan Peran Dalam Hidup</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                                <option value="2">Ya</option>
                                                        ...
                                                        <form class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Mengekspresikan Ide Melukai Orang
                                                                            </label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Akses Melakukan Tindakan
                                                                                Kekeraan</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Ide Paronoid Atau Lainnya</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                                <option value="2">Ya</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Perintah Halusinasi Untuk
                                                                                Kekerasan </label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Kemarahan, Frustasi Atau
                                                                                Agitasi</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Berkurang/Hilang Kontrol
                                                                                Diri</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
