            ...
            <div class="page-body">
                <div class="container-fluid">
                    <div class="page-title">
                        <div class="row">
                            <div class="col-6">
                                <h3>Penilaian Tambahan Bunuh Diri</h3>
                            </div>
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Tambahan Bunuh Diri</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                                        ...
                                                        <form class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Tinggal Hidup Sendiri</label>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Riwayat Upaya Suicide</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                                <option value="2">Ya</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Adanya Diaknosa Gangguan Jiwa</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                                <option value="2">Ya</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Penyakit/Disabilitas Berat</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                                <option value="2">Ya</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Berpisah/Cerai/Dusa</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                                <option value="2">Ya</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Kehilangan Pekerjaan/Tidak
                                                                                Bekerja</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                        ...
                                                        <form class="card">
                                                            ...
                                                            <div class="card-body">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Mengungkapkan Ide Bunuh Diri
                                                                            </label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Memiliki Rencana Maksud
                                                                                Suicide</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Mengungkapkan Stres Yang
                                                                                Berat</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Keputusasaan</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                                <option value="2">Ya</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Kejadian Signifikan Akhir-akhir
                                                                                Ini</label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
                                                                                <option value="0">Tidak Tau</option>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="mb-3">
                                                                            <label class="form-label">Berkurangnya/Kehilangan Kontrol
                                                                                Diri
                                                                            </label>
                                                                            <select class="form-control btn-square">
                                                                                <option value="0">Tidak</option>
