                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Awal Keperawatan IGD</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Status Kehamilan</label>
                                ...
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Abortus</label>
                                        <input type="text" class="form-control" name="" id="">
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Gravida</label>
                                        <input type="text" class="form-control" name="" id="">
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Tekanan Intrakranial</label>
                                        <select name="" id="" class="form-select">
                                ...
                                <div class="col-4">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Neurosensorik/Muskuloskeletal</label>
                                        <select name="" id="" class="form-select">
                                            <option value="">Normal</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Integumen</label>
                                        <select name="" id="" class="form-select">
                                            <option value="">TAK</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Turgor Kulit</label>
                                        <select name="" id="" class="form-select">
                                ...
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Edema</label>
                                        <select name="" id="" class="form-select">
                                ...
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Mukosa Mulut</label>
                                        <select name="" id="" class="form-select">
                                ...
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Perdarahaan</label>
                                        <select name="" id="" class="form-select">
                                            <option value="">Tidak Ada</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Jumlah (cc)</label>
                                        <input type="text" class="form-control" name="" id="">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Intoksikasi</label>
                                        <select name="" id="" class="form-select">
                                            <option value="">Tidak Ada</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Elminasi</label>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">BAB : Frekuensi</label>
                                        <input type="text" class="form-control" name="" id="">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Konsistensi</label>
                                        <input type="text" class="form-control" name="" id="">
                                    </div>
                                </div>
                                <div class="col-3">
                                ...
                                <div class="col-2">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">BAK : Frekuensi</label>
                                        <input type="text" class="form-control" name="" id="">
                                    </div>
                                </div>
                                <div class="col-2">
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">a. Kemampuan Aktifitas Sehari Hari</label>
                                        <select name="" class="form-select" id="">
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">b. Aktifitas</label>
                                        <select name="" class="form-select" id="">
                                            <option value="">Tirah Baring</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">c. Cacat Fisik</label>
                                        <input type="text" class="form-control" name="" id="">
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">d. Alat Bantu</label>
                                        <select name="" class="form-select" id="">
                                            <option value="">Tidak</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        ...
                                        <select name="" class="form-select" id="">
                                            <option value="">Tidak Ada Nyeri</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="mb-3">
                                        ...
                                        <select name="" class="form-select" id="">
                                            <option value="">Proses Penyakit</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-6">
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        ...
                                        <select name="" class="form-select" id="">
                                            <option value="">Seperti Tertusuk</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-9">
                                ...
                                <div class="col-9">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Wilayah : Lokasi</label>
                                        <input type="text" class="form-control" name="" id="">
                                    </div>
                                </div>
                                <div class="col-3">
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Severity : Skala Nyeri</label>
                                        <select name="" class="form-select" id="">
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Waktu / Durasi (Menit)</label>
                                        <select name="" class="form-select" id="">
                                            <option value="">0</option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Diberitahukan pada dokter ? </label>
                                        <select name="" class="form-select" id="">
                                ...
                                <div class="col-7">
                                    <div class="mb-3">
                                        <ul class="nav nav-tabs border-tab nav-secondary nav-left" id="danger-tab" role="tablist">
                                            <li class="nav-item"><a class="nav-link active" id="danger-home-tab" data-bs-toggle="tab" href="#danger-home" role="tab" aria-controls="danger-home" aria-selected="true"><i class="icofont icofont-ui-home"></i>Rencana Keperawatan</a></li>
                                            <li class="nav-item"><a class="nav-link" id="profile-danger-tab" data-bs-toggle="tab" href="#danger-profile" role="tab" aria-controls="danger-profile" aria-selected="false"><i class="icofont icofont-man-in-glasses"></i>Rencana Keperawatan Lainnya</a></li>
                                        </ul>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    ...
                                                                    <label class="form-check-label" for="flexCheckDefault">
                                                                        a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets c
                                                                    </label>
                                                                </div>
                                                            </td>
                                                        </tr>
