   ...
   <div class="header-wrapper row m-0">
      ...
      <div class="left-header col horizontal-wrapper ps-0">
         <ul class="horizontal-menu">
            <li class="mega-menu outside"><a class="nav-link" href="#!"><i data-feather="layers"></i><span>Menu</span></a>
                     ...
                     <div class="row">
                        <div class="col mega-box">
                           ...
                           <div class="link-section icon">
                              ...
                              <ul>
                                 <li><a href="menu_a">[A]Registrasi, Tagihan Ranap & Rajal, Pelayanan & Biling Pasien</a></li>
                                 <li><a href="menu_b">[B]Input Data Tindakan, Obat & BHP Via Barcode No.Rawat</a></li>
                                 <li><a href="menu_c">[C]Presensi, Manajemen & Penggajian Pegawai Rumah Sakit</a></li>
                                 <li><a href="menu_d">[D]Transaksi Inventory Obat, BHP Medis, Alat Kesehatan Pasien</a></li>
                                 <li><a href="menu_e">[E]Transaksi Inventory Barang Non Medis, Penunjang (LAB, RO)</a></li>
                                 <li><a href="menu_f">[F]Transaksi Inventory Barang Dapur Kering & Basah</a></li>
                                 <li><a href="menu_g">[G]Aset, Inventaris Barang & Instalasi Kesehatan Lingkungan</a></li>
                              </ul>
                           </div>
                        </div>
                     </div>
            ...
            <li class="level-menu outside"><a class="nav-link" href="#!"><i data-feather="inbox"></i><span>Shortcut</span></a>
            ...
            <li class="profile-nav onhover-dropdown p-0 me-0">
               <div class="media profile-media"><img class="b-r-10" src="../assets/images/dashboard/profile.jpg" alt="">
                  <div class="media-body"><span><?= $_SESSION['fullname'] ?></span>
                     <p class="mb-0 font-roboto">Kasir <i class="middle fa fa-angle-down"></i></p>
                  </div>
               </div>
               <ul class="profile-dropdown onhover-show-div">
                  ...
                  <li><a href="../controller/logout"><i data-feather="log-out"> </i><span>Log Out</span></a></li>
               </ul>
            </li>
         </ul>
      </div>
