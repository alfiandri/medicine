                        ...
                        <div class="login-main">
                            <form class="theme-form">
                                ...
                                <div class="form-group">
                                    <label class="col-form-label">Nomor Rekam Medis</label>
                                    <input class="form-control" type="email" required="" placeholder="0000000000">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group mb-0">
                                    <a class="link" href="forget-password.html">Lupa Nomor RM?</a>
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <p class="mt-4 mb-0"><a class="ms-2" href="../poli-tht/pilih-dokter.php">
                                                < Pilih Dokter</a>
                                        </p>
                                    </div>
                                    <div class="col-sm-6 text-end">
                                        <p class="mt-4 mb-0"><a class="ms-2" href="daftar.php">Pasien Baru
                                            </a></p>
                                    </div>
                                </div>
                            </form>
