                        ...
                        <div class="login-main">
                            <form class="theme-form">
                                ...
                                <div class="form-group">
                                    <label class="col-form-label pt-0">Nama Pasien</label>
                                    <div class="row g-2">
                                        <div class="col-6">
                                            <input class="form-control" type="text" required="" placeholder="Nama">
                                        </div>
                                        <div class="col-6">
                                            <input class="form-control" type="number" required="" placeholder="NIK">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-6">
                                            <input class="form-control" type="date" required="" placeholder="Nama">
                                        </div>
                                        <div class="col-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 text-end">
                                        <p class="mt-4 mb-0"><a class="ms-2" href="adaakun.php">Pasien Lama
                                            </a></p>
                                    </div>
                                </div>
                            </form>
