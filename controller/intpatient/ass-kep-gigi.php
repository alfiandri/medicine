...
if (isset($_POST['simpankeperawatan'])) {
   ...
   $perawatangigi = $_POST['perawatangigi'];
   $waktuperawatan = $_POST['waktuperawatan'];
   ...
   //Oral Assesment
   $kebersihanmulut = $_POST['kebersihanmulut'];
   $karies = $_POST['karies'];
   ...
   $inserkesehatan = mysqli_query($koneksi, "INSERT INTO asskepumum_kesehatangigi (uidPasien, nomorRawat, keluhanUtama, alergi, obat, sikatgigi	,penyakit, perawatanGigi, perawatanWaktu, kebiasaan)VALUES('$uid','$norawat','$keluhanutama','$alergi','$obat','$sikatgigi','$penyakit','$perawatangigi','$waktuperawatan','$kebiasaan')");
   ...
   $insertoral = mysqli_query($koneksi, "INSERT INTO assKepUmum_Intraoral (uidPasien, nomorRawat, kebersihanMulut, karies, gingiva, mukosa, karang, palatum ) VALUES ('$uid','$norawat','$kebersihanmulut','$karies','$gingiva','$mukosa','$karang','$palatum')");

   if ($insertkeadaanumum && $insertnutrisi && $insertnutrisi && $insertfungsional && $insertpsikologis && $insertjatuh && $insertgizi && $insertnyeri && $insertoral) {
